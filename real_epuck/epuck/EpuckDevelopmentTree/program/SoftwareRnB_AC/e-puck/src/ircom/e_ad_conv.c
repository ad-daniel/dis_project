...
/* june 2007: modified for 8 IR sensors sampling Valentin Longchamp	*/
/*									*/
...
// trigger proximity procedure every 81.3 usec * AD_PROX_TRIGGER
#define AD_PROX_TRIGGER 2460
...
void __attribute__((__interrupt__)) _ADCInterrupt(void)
{
    ...
    if (e_ad_prox_trigger >= AD_PROX_TRIGGER)
    {
	e_ad_prox_trigger = 0;
