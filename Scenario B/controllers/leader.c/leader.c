/*****************************************************************************/
/* File:         leader.cc                                                   */
/* Version:      1.0 -> Leader move toward a direction and memorize orientation
                        change when avoid the other                          */
/* Date:         10-Nov-18                                                   */
/* Description:  Migratory urge, robots has to avoid each other and limit odometry 
                 errors                                                      */
/*                                                                           */
/* Author: 	 10-Nov-18 by mathilde.bensimhon@epfl.ch                          */
/*****************************************************************************/

#include <stdio.h>
#include <math.h>

//See what is really usefull
...
WbDeviceTag receiver;		// Handle for the receiver node  //See how communication is done
